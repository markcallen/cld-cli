...
running command...
$ cld (--version)
cld-cli/0.1.0 darwin-x64 node-v16.17.0
$ cld --help [COMMAND]
USAGE
  $ cld COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/markcallen/cld-cli/blob/v0.1.0/dist/commands/hello/index.ts)_
